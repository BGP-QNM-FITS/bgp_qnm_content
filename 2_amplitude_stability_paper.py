...
def get_amplitude_stability_plot(
    sim_id, mode_content_data_dict, spherical_modes, t0_vals, l_max
):
    ...
    fig, axes = plt.subplots(
        1, 3, figsize=(config.fig_width_2, config.fig_height), sharey=True, dpi=300
    )
    ...
    for ax, (l, m) in zip(axes, groups_to_plot):
        possible_modes_for_plot = (
            [
                ...
                if (len(mode) == 4 or len(mode) == 2) and mode[0] == l and mode[1] == m
            ]
            + [
                mode
                for mode in unique_modes
        ...
        for mode in possible_modes_for_plot:
            ...
            for run in runs:
                ...
                if len(temp_t0_vals) > 1:
                    ...
                    ax.plot(
                        [temp_t0_vals[0] - 0.5, temp_t0_vals[0] + 0.5],
                        [amps[0], amps[0]],
                        color=color,
                        alpha=alpha,
                        lw=lw,
