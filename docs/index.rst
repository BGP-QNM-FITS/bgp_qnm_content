...
This website contains figures which supplement the manuscript: 
`The quasinormal mode content of binary black hole ringdown <https://arxiv.org/pdf/2510.13954>`_.

Links (on the left) provide access to figures for each of the 13 publicly available Cauchy characteristic evolved (CCE) 
NR simulations provided by SXS (see `Moxon+ 2020 for more details on CCE <https://arxiv.org/abs/2007.01339>`_). 
Simulations can be accessed `here <https://data.black-holes.org/waveforms/extcce_catalog.html>`_. 
...
and the full Bayesian methodology is described in `here <https://arxiv.org/pdf/2510.11783>`_.
