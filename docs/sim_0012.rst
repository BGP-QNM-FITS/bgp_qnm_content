...
This simulation contains one instance of a retrograde mode present without a prograde mode, which is not shown on the mode content plot. This is the (4, 4, 6, -) mode at timestep t0 = 4.0 [M].
